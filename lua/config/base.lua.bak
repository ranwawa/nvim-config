...
vim.wo.foldmethod = "expr" -- 使用表达式折叠
vim.wo.foldexpr = "nvim_treesitter#foldexpr()" -- 使用treesitter的折叠表达式
...
vim.api.nvim_create_autocmd("VimLeave", {
  callback = function()
    ...
    vim.fn.system("cd " .. config_dir .. " && git add -A && git diff --cached --quiet || (git commit -m 'auto: sync nvim config' && git push)")
  end,
})
